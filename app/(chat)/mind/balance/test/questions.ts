...
export const BALANCE_QUESTIONS: BalanceQuestion[] = [
  ...
  { id: "e4", domain: "emotion", text: "Санаа зовнил, түгшүүр тань өдөр тутмын амьдралд хүчтэй нөлөөлдөгүү?" },
  ...
  { id: "s2", domain: "self", text: "Өөрийн сорилт үүсгэдэгсул талаа (ж: хойшлуулах, хэт бодох) мэдэх үү?" },
  ...
  { id: "r6", domain: "relations", text: "Бусдын хандлага, үг, яриа таны сэтгэл санааг савлуулдаг уу?" },
  ...
  { id: "p5", domain: "purpose", text: "Хийх ёстой зүйлээ хойшлуулах зуршил таныг их гацаадаг уу?" },
