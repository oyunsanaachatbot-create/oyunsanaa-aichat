...
export const BALANCE_QUESTIONS: BalanceQuestion[] = [
  ...
  { id: "c3", domain: "selfCare", text: "Та өөртөө амрах, сэргэх хугацааг санаатайгаар гаргаж чаддаг уу?" },
  { id: "c4", domain: "selfCare", text: "Та өөрийн биеийн дохиог (ядаргаа, өлсөх, өвдөх) анзаарч, цагт нь анхаарч чаддаг уу?" },
  { id: "c5", domain: "selfCare", text: "Та өөрийгөө бусадтай хэт харьцуулснаас болж өөрийгөө буруутгах нь их байдаг уу?", reverse: true },
  { id: "c6", domain: "selfCare", text: "Та өөртөө урам өгч, жижиг амжилтаа тэмдэглэдэг үү?" },
  ...
  { id: "l6", domain: "life", text: "Өдөр тутмын амьдралд тань тогтмол хэмнэл (ажил/амралт/гэр) хадгалагддаг уу?" },
];
