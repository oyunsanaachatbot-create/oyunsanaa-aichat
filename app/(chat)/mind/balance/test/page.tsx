...
export default function BalanceTestPage() {
  ...
  const onFinish = () => {
    // ✅ бүрэн бөглөөгүй бол дүгнэлт рүү явуулахгүй
  ...
  return (
    <div
      ...
      style={{
        // ✅ brand өнгийг background дээр илүү мэдэгдэхээр
        background: `radial-gradient(1200px 650px at 50% -10%, rgba(${BRAND.rgb},0.60), rgba(2,8,22,1) 58%)`,
      }}
    >
      <main className="px-4 py-6 md:px-6 md:py-10 flex justify-center">
        <div
          className="w-full max-w-3xl rounded-3xl border bg-white/10 backdrop-blur-2xl shadow-[0_24px_80px_rgba(15,23,42,0.9)] px-4 py-5 md:px-7 md:py-7 space-y-5"
        ...
        >
          ...
          {/* header */}
          <div
            className="rounded-2xl border bg-white/10 px-4 py-4"
            style={{
              borderColor: "rgba(255,255,255,0.16)",
              boxShadow: `inset 0 0 0 1px rgba(31,111,178,0.22)`,
            }}
          >
          ...
          {!started ? (
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                ...
                >
                  <Image
                    ...
                    height={420}
                    priority
                    className="block h-[360px] w-[270px] sm:h-[420px] sm:w-[320px] object-cover"
                  />
                </div>
              </div>
              ...
              {/* Intro text */}
              <div
                className="rounded-2xl border bg-white/10 p-4 text-sm sm:text-base leading-relaxed"
                style={{
                  borderColor: "rgba(255,255,255,0.16)",
                  boxShadow: `inset 0 0 0 1px rgba(31,111,178,0.18)`,
                }}
              >
                <p className="text-slate-50">
                  Сайн байна уу. Сэтгэлийн туслагч <b>Оюунсанаа</b> байна.
                  Би бол таны зүрх сэтгэл, оюун санааг амар тайван байхад туслахаар зориулагдан бүтээгдсэн AI дүр юм.
                </p>

                <p className="mt-3 text-slate-100/90">
                  Сэтгэлийн боловсрол эзэмших нь амар тайван амьдралын суурь болдог.
                  <b> Сэтгэл санаа</b>, <b>өөрийгөө ойлгох</b>, <b>харилцаа</b>, <b>зорилго</b>,
                  <b> өөртөө анхаарах</b>, <b>тогтвортой амьдрал</b> гэсэн 6 хүчин зүйлийн тэнцвэрийг
                  алдахгүй амьдрах нь сэтгэлийн боловсрол юм.
                </p>
                ...
                {/* medical disclaimer (зөөлөн, зөв байрлал) */}
                <p className="mt-3 text-xs text-slate-100/70">
                  Тэмдэглэл: Би эмч биш. Эмчилгээ, онош тавихгүй. Хэрвээ танд яаралтай тусламж хэрэгтэй санагдвал
            ...
            <>
              ...
              {/* ✅ доор 2 товч (Дүгнэлт + Тест эхлүүлэх/reset эсвэл дуусгах) — өмнө тохирсон хэвээр */}
