...
export default function BalanceTestPage() {
  ...
  const onSubmit = () => {
    ...
    // түүх (refresh/шууд ороход алдагдахгүй)
  ...
  return (
    <div
      ...
      style={{
        // ✅ брэнд өнгө тогтвортой (хар руу унахгүй)
        background:
          `radial-gradient(1200px 600px at 50% -10%, rgba(255,255,255,0.18), rgba(255,255,255,0) 60%), ${BRAND.hex}`,
      }}
    >
      <main className="px-4 py-6 md:px-6 md:py-10 flex justify-center">
        <div className="w-full max-w-3xl rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl shadow-[0_24px_80px_rgba(15,23,42,0.35)] px-4 py-5 md:px-7 md:py-7 space-y-5">
          ...
          {!started ? (
            // ✅ START SCREEN: зураг → текст → доод талд зөвхөн "Тест эхлэх"
            <div className="space-y-4">
              <div className="rounded-3xl border border-white/20 bg-white/10 p-5 sm:p-6">
                <div className="flex flex-col items-center text-center gap-4">
                  {/* Oyunsanaa image */}
                  <div className="relative h-28 w-28 sm:h-32 sm:w-32 overflow-hidden rounded-full border border-white/25 bg-white/10">
                    {/* ✅ зурагны path-аа өөрийнхтэй тааруул: public/images/oyunsanaa.png */}
                    <Image
                  ...
                  {/* text */}
                  <div className="space-y-3 text-sm sm:text-[15px] leading-relaxed text-white/90">
                    <p>
                      Сайн байна уу. сэтгэлйн туслагч <b>Оюунсанаа</b> байна. Би бол таны зүрх сэтгэл, оюун
                      санааг амар тайван байхад туслахаар зориулагдан бүтээгдсэн <b>AI дүр</b> юм.
                    </p>

                    <p>
                      Сэтгэлийн боловсрол эзэмших нь амар тайван амьдралын суурь болдог. сэтгэл санаа,
                      өөрийгөө ойлгох, харилцаа, зорилго, өөртөө анхаарах, тогтвортой амьдрал гэсэн 6 хүчин
                      зүйлийн тэнцвэрийг алдахгүй амьдрах нь сэтгэлийн боловсрол юм.
                    </p>

                    <p>Таны сэтгэлийн тэнцэв хэр байгааг богино тэстээр шалгацгаая.</p>

                    <p className="text-xs text-white/70">
                      Жич: Oyunsanaa нь эмч биш. Онош тавих, эм бичихгүй. Харин зөв мэдээлэл, өдөр тутмын энгийн
                      зөвлөмжөөр дэмжинэ.
                    </p>
                  </div>
                </div>
