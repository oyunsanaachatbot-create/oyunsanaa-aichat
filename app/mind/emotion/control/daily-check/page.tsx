...
function summaryLine(level: Level, score: number) {
  ...
  if (level === "Orange") return `Өнөөдөр анхаарал хэрэгтэй өдөр байна 🧡 (${score}/100)`;
  return `Өнөөдөр өөртөө илүү зөөлөн хандах өдөр байна ❤️ (${score}/100)`;
}
...
function detailLine(level: Level) {
  ...
  if (level === "Orange") return "Сэтгэл санаа савлаж магадгүй. Ус уух, амьсгал, богино алхалт зэрэг жижиг зүйлс тусална.";
  return "Одоо хамгийн түрүүнд аюулгүй, тайван орчин хэрэгтэй. Хэрвээ боломжтой бол хэн нэгэнд хэлээд дэмжлэг аваарай.";
}
