...
export const personalityBasic: TestDefinition = {
  ...
  bands: [
    ...
    },
    {
      ...
      tips: ["Өнөөдөр нэг жижиг “үгүй” хэлж сур: “Одоохондоо амжихгүй байна” гэж хэлээд үз."],
    },
    {
      minPct: 0,
      ...
      tips: [
        "Өнөөдөр: 10 минут алхах эсвэл 5 минут чимээгүй суу.",
        "Дараа нь 1 өгүүлбэр бич: “Одоо надад хамгийн хэрэгтэй зүйл бол …”",
      ],
    },
  ],
};
